...
- XLSX export/import now preserves the supported conditional-formatting predicates (numeric comparisons, text contains, data bars, and color scales) through native worksheet conditional-format parts; differential styles and advanced formula rules remain partial.
